    ...
    <div className='py-5'>
      <Container className='d-flex justify-content-center'>
        <Card className='p-5 d-flex flex-colum align-items-center hero-card bg-light w-75'>
          ...
          <p className='text-center mb-4'>This is a bolierplate for MERN authentication that stores a JWT in an HTTP-Only Cookie. It also uses Redux Toolkit and the React Bootstrap library</p>
